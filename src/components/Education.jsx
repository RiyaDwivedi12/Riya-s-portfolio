      ...
      <div className="relative pl-6 border-l border-slate-200 dark:border-slate-800 space-y-12 py-2">
        {education.map((edu, idx) => (
          ...
          >
            ...
            {/* Content card */}
            <div className="p-6 rounded-2xl bg-white/40 dark:bg-slate-900/40 border border-slate-200/50 dark:border-slate-800/50 hover:bg-white/60 dark:hover:bg-slate-900/60 shadow-lg hover:shadow-xl transition-all duration-300 space-y-3">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wider font-mono">
                  {edu.institution}
                </p>
              </div>
              ...
              {/* CGPA / Marks badge */}
              <div className="pt-2">
                <span className="inline-block px-3 py-1.5 rounded-lg text-xs font-bold font-mono bg-sky-500/10 text-sky-600 dark:text-sky-400">
                  {edu.score}
                </span>
              </div>
            </div>
